...
export default function Program() {
  ...
  return (
    <div className="text-fontColor text-[0.8rem]  w-full pt-4 px-5 overflow-auto h-full ">
      ...
      <div className=" pt-5 space-y-5 flex flex-col ">
        <div className="flex justify-between">
          <Dialog className=" ">
            ...
            <DialogContent className="w-1/2 h-[80%]  ">
              <form
                action="#"
                onSubmit={submit}
                className=" flex  flex-col h-full overflow-auto w-full min-h-full  "
              >
                  ...
                  <table className="w-full text-left  max-h-full ">
                    ...
                    <thead className="sticky top-0 ">
                      <tr className="border-grayish text-grayish">
                        ...
                        <th className="text-grayish">Email</th>
                      </tr>
                    </thead>
        ...
        {listOfStudents.length != 0 ? (
          <>
            ...
            {listOfStudents
              ?.filter((stud) =>
                stud.student_id.toString().includes(searchstudent)
              )
              .map((enrolled, index) => (
